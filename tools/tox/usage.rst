...
If you want to test on multiple Python Versions, you might want to use :ref:`pyenv` to per project the capability to define the actuall used Python versions in detail (Major, Minor and Buxfix-Release).
